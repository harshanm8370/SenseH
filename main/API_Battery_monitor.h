...
#define FUEL_GUAGE_10_PER_VOLTAGE          (float)	3.5//(float) (((FUEL_GUAGE_VOLTAGE_DIFF * 10) / 100) + FUEL_GUAGE_MIN_VOLTAGE)
#define FUEL_GUAGE_15_PER_VOLTAGE          (float)	3.6//(float) (((FUEL_GUAGE_VOLTAGE_DIFF * 15) / 100) + FUEL_GUAGE_MIN_VOLTAGE)
#define FUEL_GUAGE_33_PER_VOLTAGE          (float)	3.8//(float) (((FUEL_GUAGE_VOLTAGE_DIFF * 33) / 100) + FUEL_GUAGE_MIN_VOLTAGE)
#define FUEL_GUAGE_66_PER_VOLTAGE          (float)  4.0//(float) (((FUEL_GUAGE_VOLTAGE_DIFF * 66) / 100) + FUEL_GUAGE_MIN_VOLTAGE)
